...
export default function Home() {
  return (
    <div className="w-full min-h-screen h-full bg-[radial-gradient(circle,_#ebecff_0%,_#ffffff_37%,_#e2e4ff_61%,_#d6f0fa_100%)] dark:bg-[radial-gradient(circle,_#a3a6b2_0%,_#15182c_16%,_#000000_37%,_#222222_91%,_#000000_100%)]">
      <Header />
