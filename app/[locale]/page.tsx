...
export default function Home() {
  ...
  return (
    <div className="w-full min-h-screen h-full bg-[radial-gradient(circle,_#ebecff_0%,_#ffffff_37%,_#e2e4ff_61%,_#d6f0fa_100%)] dark:bg-[radial-gradient(circle,_#64696f_0%,_#101012_25%,_#000000_47%,_#222222_91%,_#000000_100%)]">
      <Header />
